...
/*  Wifi configs  */
char ssid[] = "wlan 3";          // your network SSID (name)
char pass[] = "liacs_8_";                    // your network password

/*  OSC configs  */
WiFiUDP Udp;                                // A UDP instance to let us send and receive packets over UDP
const IPAddress outIp(132, 229, 130, 149);  // remote IP of your computer
const unsigned int outPort = 1337;          // remote port to receive OSC
const unsigned int localPort = 8888;        // local port to listen for OSC packets (actually not used for sending)
String pleasure = "/pleasure";

/*  Multiplexer configs  */
CD74HC4067 multiplexer(4, 5, 6, 7);
